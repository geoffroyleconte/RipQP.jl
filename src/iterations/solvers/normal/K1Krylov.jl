...
mutable struct K1ToK3Residuals{T, S <: AbstractVector{T}, M, MA, Sr <: Union{Int, StorageGetxRestartedGmres{S}}}
  K::M
  rhs::S
  atol::T
  rtol::T
...
function PreallocatedData(
  ...
  rd = sp.k3_resid ? ToK3Residuals(K, rhs, itd, pt, id, sp, fd, D, KS) : 0
